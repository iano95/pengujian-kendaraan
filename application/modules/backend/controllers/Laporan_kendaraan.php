...
class Laporan_kendaraan extends Backend{

  private $title = "Laporan Kendaraan";
  ...
  { 
    $this->db->select('tb_kendaraan.*,tb_tarif.*,tb_pemohon.nama_pemilik');
    ...
    $this->template->view("content/laporan/kendaraan",$data);
